...
module.exports = (sequelize, DataType) => {
  const usuario = sequelize.define('usuario', {
    ...
    classMethods: {
      ...
      associate: (models) => {
        usuario.belongsTo(models.persona, { as: 'persona', foreignKey: { name: 'fid_persona', allowNull: false, xchoice:'nombres'} });
        usuario.hasMany(models.usuario_rol, { as: 'usuarios_roles', foreignKey: { name: 'fid_usuario', allowNull: false , xchoice:'id_usuario_rol'} });
      },
      tableName: 'usuario',
      buscarIncluye: (Persona, UsuarioRol, Rol, condicion) => usuario.findAndCountAll({
        attributes: ['id_usuario', 'email', 'estado', 'observaciones', 'fid_persona'],
        ...
        include: [{
          model: Persona,
          as: 'persona',
          attributes: ['documento_identidad', 'complemento_documento', 'fecha_nacimiento', 'nombres', 'primer_apellido', 'segundo_apellido', 'casada_apellido', 'sexo'],
          required: true,
        },
        {
          model: UsuarioRol,
      ...
      buscarIncluyeOne: (id, Persona, UsuarioRol, Rol) => usuario.findOne({
        ...
        include: [{
          ...
          attributes: ['documento_identidad', 'complemento_documento', 'fecha_nacimiento', 'nombres', 'primer_apellido',
            'segundo_apellido', 'casada_apellido', 'sexo'],
        },
        {
          model: UsuarioRol,
          as: 'usuarios_roles',
